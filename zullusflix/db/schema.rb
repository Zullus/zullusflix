...
ActiveRecord::Schema.define(version: 20180523235451) do
  ...
  create_table "reviews", force: :cascade do |t|
    t.integer "rating"
    t.text "description"
    t.string "reviwable_type"
    t.bigint "reviwable_id"
    t.bigint "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["reviwable_type", "reviwable_id"], name: "index_reviews_on_reviwable_type_and_reviwable_id"
